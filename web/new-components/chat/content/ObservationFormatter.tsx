        ...
        return (
          <div className='space-y-2'>
            <div className='flex items-center gap-2'>
              ...
              <span className='text-xs font-semibold text-gray-600 dark:text-gray-400 uppercase'>{t('dataObservation')}</span>
            </div>
                ...
                <div className='flex items-center gap-2'>
                  ...
                  <span className='text-gray-700 dark:text-gray-300'>
                    ...
                    <span className='font-mono font-medium text-blue-600 dark:text-blue-400 ml-1'>
                      {t('dataShapeRowsCols', { rows: parsed.data.shape[0], cols: parsed.data.shape[1] })}
                    </span>
                  </span>
                </div>
              )}
              {parsed.data.columns && parsed.data.columns.length > 0 && (
                <div className='flex items-start gap-2'>
                  ...
                  <div className='flex-1'>
                    <span className='text-gray-700 dark:text-gray-300'>{t('fieldList')}</span>
      ...
      case 'dtypes':
        return (
          <div className='space-y-2'>
            <div className='flex items-center gap-2'>
              <span className='text-lg'>🔍</span>
              <span className='text-xs font-semibold text-gray-600 dark:text-gray-400 uppercase'>{t('dataTypes')}</span>
            </div>
      ...
      case 'columns':
        return (
          <div className='space-y-2'>
            <div className='flex items-center gap-2'>
              <span className='text-lg'>📋</span>
              <span className='text-xs font-semibold text-gray-600 dark:text-gray-400 uppercase'>{t('columnInfo')}</span>
            </div>
      ...
      default:
        return (
          <div className='space-y-2'>
            <div className='flex items-center gap-2'>
              <span className='text-lg'>📄</span>
              <span className='text-xs font-semibold text-gray-600 dark:text-gray-400 uppercase'>{t('observationResult')}</span>
            </div>
