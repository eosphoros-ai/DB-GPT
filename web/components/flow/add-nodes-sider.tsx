...
const AddNodesSider: React.FC = () => {
  ...
  return (
    <Sider
      className="nodrag bg-[#ffffff80] border-r border-[#d5e5f6] dark:bg-[#ffffff29] dark:border-[#ffffff66] flex justify-center items-center"
      theme={mode}
      width={280}
      collapsible={true}
      collapsed={collapsed}
    ...
    >
      <Space
        direction="vertical"
        className="w-[280px] p-4 overflow-hidden overflow-y-auto scrollbar-default"
      >
