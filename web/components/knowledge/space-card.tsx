      ...
      >
        <Badge className="mb-4 min-w-[200px] sm:w-60 lg:w-72" count={space.docs || 0}>
          <GptCard
            title={space.name}
            desc={space.desc}
            icon={space.field_type === 'FinancialReport'?"/models/fin_report.jpg":space.vector_type === 'KnowledgeGraph'?"/models/knowledge-graph.png":space.vector_type === 'FullText'?"/models/knowledge-full-text.jpg":"/models/knowledge-default.jpg"}
            iconBorder={false}
            tags={[
              {
                text: (
