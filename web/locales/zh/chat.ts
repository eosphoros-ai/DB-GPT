...
export const ChatZh: Resources['translation'] = {
  ...
  example_fin_report_desc: '分析企业年度报告，生成数据可视化报告',
  example_fin_report_query:
    '请深度分析这份年度报告，包括营收利润趋势、资产负债结构、现金流分析、关键财务指标等，生成一份专业的交互式网页分析报告。',
  ...
  Thinking: '思考中',
  copy_sql: '复制SQL',
  feedback_submitted: '反馈成功',
  result: '观察结果',
  data_type: '数据类型',
  saturday: '星期六',
  you_might_want_to_ask: '或许你想问：',
  column_info: '列信息',
  field_list: '字段列表：',
  copy_all: '复制全部',
  yesterday: '昨天',
  ...
  tuesday: '星期二',
  view_reply_reference: '查看回复引用',
  thursday: '星期四',
  friday: '星期五',
  items: '项)',
  popup_blocked_by_browser_please_allow_and_retry: '浏览器阻止了弹出窗口，请允许后重试',
  no_files_yet: '暂无文件',
  ...
  sunday: '星期日',
  please_wait_results_will_appear_shortly: '请稍候，结果即将显示',
  data_observation: '数据观察',
  wednesday: '星期三',
  running_3: '正在执行...',
  i_can_help_you: '我可以帮您：',
  outputs: '个输出',
  today: '今天',
  click_to_analyze_current_anomaly: '点击分析当前异常',
  click_a_step_card_on_the_left_to_view_results: '点击左侧的步骤卡片以显示执行结果',
  reply_reference: '回复引用',
  select_a_step_to_view_details: '选择一个步骤查看详情',
  result_2: '执行结果',
  link: '链接',
  completed_2: '就绪',
  sql_copied_to_clipboard: 'SQL已复制到剪贴板',
  column: '列',
  no_output_yet: '暂无输出结果',
  code_file: '代码文件',
  ...
  // phase2 i18n
  source_code: '源代码',
  rendered_result: '渲染结果',
  artifact_date_md: '{{month}}月{{day}}日',
