...
export const CommonZh: Resources['translation'] = {
  ...
  recommended_questions_tooltip: '点击选择，自动填入',
  question: '问题',
  ...
  request_error: '请求错误',
  api_interface_abnormal: '接口异常，请稍后重试',
  network_error: '网络错误',
  ...
  pending: '待处理',
  are_you_sure_you_want_to_delete: '确认删除吗？',
  rounds_pending_replay: '轮待回放...',
  search_knowledge_base: '搜索知识库',
  ask_me_anything: '可以问我任何问题',
  dataset_count: '数据集数量',
  file_download_failed: '文件下载失败',
  admin_employee_id_leading_zeros_removed: '管理员（工号，去前缀0）：',
  no_matching_conversations: '没有匹配的对话',
  new_chat_2: '新对话',
  invalid_data_format: '数据格式错误',
  failed_to_load_evaluation_list: '获取评估列表失败',
  share_link_copied_to_clipboard: '分享链接已复制到剪贴板！',
  end_topic: '终止话题',
  search_database: '搜索数据库',
  permission_management: '权限管理',
  failed_to_load_chat_history: '加载历史对话失败',
  scene_type: '场景类型',
  enter_a_test_question: '请输入测试问题',
  sql_query: 'sql查询',
  confirm_delete: '确认删除吗',
  databases_available: '个数据库可用',
  skills_available: '个技能可用',
  databases_available_count: '{{count}}个数据库可用',
  skills_available_count: '{{count}}个技能可用',
  knowledge_bases_available_count: '{{count}}个知识库可用',
  no_suitable_chart_view: '暂无合适的可视化视图',
  evaluation_results: '测评结果',
  failed_to_load_example: '加载示例失败: ',
  added_successfully: '添加成功',
  just_now: '刚刚',
  no_history_yet: '暂无历史记录',
  steps: '步',
  no_matching_knowledge_base: '未找到匹配的知识库',
  numeric: '数值',
  parallel_parameters: '并行参数',
  delete: '已删除',
  clear_history: '清除历史',
  back: '返回',
  ...
  pause_reply: '暂停回复',
  failed_to_create_share_link_please_try_again_lat: '创建分享链接失败，请稍后重试',
  personal: '个人',
  evaluation_data: '评测数据',
  start_a_conversation_before_sharing: '请先开始一段对话再分享',
  manage_databases: '管理数据库 →',
  recall_results: '召回结果',
  try_again_2: '再来一次',
  file_not_available_for_download: '文件暂不可下载',
  started_successfully: '发起成功',
  load_failed: '加载失败',
  vector_retrieval_settings: '向量检索设置',
  start_evaluation: '发起测评',
  storage_mode: '储存方式',
  sample_annual_report_2019_pdf: 'sample_annual_report_2019.pdf',
  storage_type: '储存类型',
  knowledge_bases_available: '个知识库可用',
  edit_dataset: '编辑数据集',
  invalid_header_json_format: 'Header信息格式不正确,请输入有效的JSON格式',
  ...
  manage_skills: '管理技能 →',
  members: '成员',
  no_database_available: '暂无可用数据库',
  evaluation_status: '测评状态',
  add_dataset: '添加数据集',
  failed: '失败',
  delete_this_conversation: '确认删除这条对话记录吗？',
  manage_knowledge: '管理知识库 →',
  evaluation_metrics: '评测指标',
  no_matching_skills_found: '未找到匹配的技能',
  view_logs_and_scores: '查看日志与评分',
  score_threshold: 'score阈值',
  recall_configuration: '召回配置',
  encoding: '编码',
  ...
  test: '测试',
  test_question: '测试问题',
  invalid_response_mapping_json_format: 'Response Mapping配置格式不正确,请输入有效的JSON格式',
  dataset: '数据集',
  related_questions: '关联问题:',
  enter_password: '请输入密码',
  your_feedback_helps_me_improve: '你的反馈助我进步',
  no_skills_available: '暂无可用技能',
  evaluation_metrics_2: '测评指标',
  scene_parameters: '场景参数',
  no_matching_database_found: '未找到匹配的数据库',
  evaluation_code: '测评编码',
  start_evaluation_2: '发起评测',
  uploading: '上传中',
  help_center: '帮助中心',
  ...
  hours_ago: '{{count}}小时前',
  days_ago: '{{count}}天前',
  pagination_total: '共 {{count}} 条',
  collapse: '收起',
  expand: '展开',
  share_link_invalid_expired: '分享链接无效或已过期 ({{status}})',
  share_replay_suffix: '· DB-GPT 回放',
  share_round_n: '第 {{n}} 轮',
  resource_type_label: '资源类型{{type}}',
