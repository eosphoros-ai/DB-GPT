...
export const CommonZh: Resources['translation'] = {
  ...
  ui_1ac07a4b: '新对话',
  ui_1cede985: '数据格式错误',
  ui_1e27e0e4: '获取评估列表失败',
  ui_1fa20d8f: '分享链接已复制到剪贴板！',
  ui_212ed895: '终止话题',
  ui_22ef51f6: '搜索数据库',
  ui_23bbdd59: '权限管理',
  ...
  ui_6359b6d6: '暂无可用知识库',
  ui_6457723a: '暂停回复',
  ui_6922a577: '创建分享链接失败，请稍后重试',
  ui_6a0e0419: '个人',
  ui_6d418f20: '评测数据',
  ui_78319b94: '请先开始一段对话再分享',
  ui_7be22669: '管理数据库 →',
  ui_7ded4c62: '召回结果',
  ui_7f7c7dcf: '再来一次',
  ui_80efb78d: '文件暂不可下载',
  ...
  ui_96cef24e: '个知识库可用',
  ui_986d0c2f: '编辑数据集',
  ui_9c6513ad: 'Header信息格式不正确,请输入有效的JSON格式',
  ui_9d197a15: '文件预览失败',
  ui_9da412d9: '数据集名称',
  ui_a001a226: '更新时间',
  ui_a0cfcad5: '表单验证失败:',
  ...
  ui_ac0493bf: '添加数据集',
  ui_acd5cb84: '失败',
  ui_ad3c3af3: '确认删除这条对话记录吗？',
  ui_aff2be5a: '管理知识库 →',
  ui_b6c1a442: '评测指标',
  ui_bca797aa: '未找到匹配的技能',
  ui_bea38560: '查看日志与评分',
  ui_c4e66204: 'score阈值',
  ui_cbd5ff76: '召回配置',
  ui_cc6c35a3: '编码',
  ...
  ui_db06c78d: '测试',
  ui_dd60233d: '测试问题',
  ui_e133c616: 'Response Mapping配置格式不正确,请输入有效的JSON格式',
  ui_e20804e3: '数据集',
  ui_e20fa153: '关联问题:',
  ui_e39ffe99: '请输入密码',
  ui_e6bf2072: '你的反馈助我进步',
  ui_e809e468: '暂无可用技能',
  ui_e88bef86: '测评指标',
  ui_ea9056f0: '场景参数',
  ui_f19a52d9: '未找到匹配的数据库',
  ui_fb0e2552: '测评编码',
  ui_fbde4ef0: '发起评测',
  ui_fc09a73e: '上传中',
  ui_fe4416f2: '帮助中心',
