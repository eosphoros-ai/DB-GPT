export const CommonEn = {
  ...
  recommended_questions_tooltip: 'Click to select and auto-fill',
  question: 'Question',
  ...
  api_interface_abnormal: 'The interface is abnormal. Please try again later',
  ...
  databases_available_count: '{{count}} databases available',
  skills_available_count: '{{count}} skills available',
  knowledge_bases_available_count: '{{count}} knowledge bases available',
  ...
  failed_to_create_share_link_please_try_again_lat: 'Failed to create share link, please try again later',
  personal: 'Personal',
  evaluation_data: 'Evaluation data',
  start_a_conversation_before_sharing: 'Start a conversation before sharing',
  manage_databases: 'Manage databases →',
  recall_results: 'Recall results',
  try_again_2: 'Try again',
  file_not_available_for_download: 'File not available for download',
  ...
  members: 'Members',
  no_database_available: 'No database available',
  ...
  scene_parameters: 'Scene parameters',
  ...
  pagination_total: 'Total {{count}} items',
  collapse: 'Collapse',
  expand: 'Expand',
  share_link_invalid_expired: 'Share link is invalid or expired ({{status}})',
  share_replay_suffix: '· DB-GPT Replay',
  share_round_n: 'Round {{n}}',
  resource_type_label: 'Resource type: {{type}}',
