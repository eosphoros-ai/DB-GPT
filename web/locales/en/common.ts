export const CommonEn = {
  ...
  finance_page_title: 'Financial Reports - Public Financial Report Collection, Analysis & Traceable Research',
  finance_placeholder: 'Enter a company name, e.g. Sample Tech',
  finance_analyze: 'Analyze',
  finance_loading: 'Collecting and analyzing public financial reports...',
  finance_report_title: 'Analysis Report',
  finance_analyze_failed: 'Analysis failed: ',
  finance_enter_company: 'Please enter a company name',
  finance_kpi_title: 'Key Metrics',
  finance_provenance_title: 'Provenance',
  finance_full_report: 'Full Report',
  finance_col_metric: 'Metric',
  finance_col_period: 'Period',
  finance_col_value: 'Value',
  finance_col_source: 'Source',
  finance_col_evidence: 'Evidence',
  finance_col_extracted_at: 'Extracted At',
  finance_latest_yoy: 'Latest YoY',
  finance_metric_revenue: 'Revenue',
  finance_metric_gross_profit: 'Gross Profit',
  finance_metric_net_profit: 'Net Profit',
  finance_metric_operating_cash_flow: 'Operating Cash Flow',
  finance_metric_gross_margin: 'Gross Margin',
  finance_metric_net_margin: 'Net Margin',
  finance_no_evidence: '(none)',
  finance_no_results: 'No results',
  finance_trend_title: 'Trend Analysis',
  finance_single_mode: 'Single Company',
  finance_compare_mode: 'Compare',
  finance_compare_placeholder: 'Enter company names separated by commas, e.g. Apple, Microsoft',
  finance_compare_need_two: 'Please enter at least two company names',
  finance_compare: 'Compare',
  finance_latest_qoq: 'Latest QoQ',
  finance_segments_title: 'Revenue by Segment',
  finance_regions_title: 'Revenue by Region',
  finance_quarterly_trend_title: 'Quarterly Revenue Trend',
  finance_upload: 'Upload Files',
  finance_upload_hint: 'Supports CSV / Excel / PDF, analyzed jointly with public sources',
  finance_quarterly_suffix: '(Quarterly)',
  finance_compare_title: 'Comparison',
  finance_compare_latest: 'Latest',
  finance_compare_mean: 'Mean',
  finance_col_name: 'Item',
  finance_col_amount: 'Revenue (100M)',
  finance_col_ratio: 'Share',
  finance_col_source_type: 'Source Type',
  finance_source_eastmoney: 'Structured',
  finance_source_baidu: 'Search Snippet',
  finance_source_web: 'Web',
  finance_source_pdf: 'PDF',
  finance_source_csv: 'CSV',
  finance_source_excel: 'Excel',
  finance_source_upload: 'Upload',
  // Skills page
