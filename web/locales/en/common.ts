export const CommonEn = {
  ...
  data_center_desc:
    'Zhonghuan Information also offers a user-friendly data center management interface for efficient data maintenance.',
  ...
  dbgpts_community: 'App Community',
  community_dbgpts: 'Community Apps',
  my_dbgpts: 'My Apps',
