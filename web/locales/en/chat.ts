export const ChatEn = {
  ...
  example_fin_report_desc: 'Analyze a company annual report and generate a data visualization report',
  example_fin_report_filename: 'sample_annual_report_2019.pdf',
  example_fin_report_query:
    'Please deeply analyze the attached annual report, including revenue and profit trends, asset and liability structure, cash flow analysis, and key financial indicators, and generate a professional interactive web analysis report.',
  ...
  sunday: 'Sunday',
  please_wait_results_will_appear_shortly: 'Please wait, results will appear shortly',
  ...
  click_a_step_card_on_the_left_to_view_results: 'Click a step card on the left to view results',
  reply_reference: 'Reply reference',
  select_a_step_to_view_details: 'Select a step to view details',
  result_2: 'Result',
  link: 'Link',
