...
from dbgpt.agent.core.agent_manage import mentioned_agents, participant_roles
...
class AutoPlanChatManager(ManagerAgent):
    ...
    profile: ProfileConfig = ProfileConfig(
        ...
        goal=DynConfig(
            "Advance the task reasoning_engine generated by the planning agent. If the reasoning_engine "  # noqa: E501
        ...
        for i in range(self.max_round):
            ...
            if not plans or len(plans) <= 0:
                ...
                if not todo_plans or len(todo_plans) <= 0:
                    # The reasoning_engine has been fully executed and a success message is sent    # noqa: E501
                    # to the user.
                    # complete
                    return ActionOutput(
                        is_exe_success=True,
