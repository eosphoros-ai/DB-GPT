...
class ModelOutput:
    ...
    """The tool calls generated by the model (native function calling), in the
...
class ModelRequest:
    ...
    """The tools available to the model, in the OpenAI ``tools`` array shape."""
    tool_choice: Optional[Union[str, Dict[str, Any]]] = None
    """Controls how the model may call tools (e.g. "auto", "none" or a dict)."""
