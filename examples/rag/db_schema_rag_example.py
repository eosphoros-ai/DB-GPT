...
def _create_vector_connector():
    ...
    return VectorStoreConnector.from_default(
        ...
        embedding_fn=DefaultEmbeddingFactory(
            ...
            default_model_name='/datas/liab/embeddings_model/gte-large-zh',
        ).create(),
    )
def _create_vector_connector1():
    """Create vector connector."""
    return VectorStoreConnector.from_default(
        "PGVector",
        vector_store_config=PGVectorConfig(
            name="db_schema_vector_store_name",
            connection_string='postgresql+psycopg2://fastgpt:1234@172.23.10.249:8100/public',
        ),
        embedding_fn=DefaultEmbeddingFactory(
            # default_model_name=os.path.join(MODEL_PATH, "text2vec-large-chinese"),
            default_model_name='/datas/liab/embeddings_model/gte-large-zh',
...
if __name__ == "__main__":
    ...
    vector_connector = _create_vector_connector1()
