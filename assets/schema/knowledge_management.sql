...
(
    ...
    `prompt_name`    varchar(128) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'prompt name',
    ...
    `model` varchar(64) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Prompt model name(we can use different models for different prompt)',
