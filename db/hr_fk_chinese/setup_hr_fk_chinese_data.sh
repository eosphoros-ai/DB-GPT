...
# hr_chinese_dev
/datas/liab/miniconda3/envs/dbgpt_test/bin/python3 /datas/liab/DB-GPT/db/hr_fk_chinese/CreatePersonnelBasicInfoTableSqlChineseReal.py hr_chinese_dev
/datas/liab/miniconda3/envs/dbgpt_test/bin/python3 /datas/liab/DB-GPT/db/hr_fk_chinese/CreateaZthrZpListTableSqlChineseReal.py hr_chinese_dev
/datas/liab/miniconda3/envs/dbgpt_test/bin/python3 /datas/liab/DB-GPT/db/hr_fk_chinese/CreateEducationInfoTableSqlChineseReal.py hr_chinese_dev
/datas/liab/miniconda3/envs/dbgpt_test/bin/python3 /datas/liab/DB-GPT/db/hr_fk_chinese/CreatePositionInformationSynchronizationTableSqlChineseReal.py hr_chinese_dev
...
# muplus_chinese
/datas/liab/miniconda3/envs/dbgpt_test/bin/python3 /datas/liab/DB-GPT/db/mupluse_chinese/CreateaPlusAttxCCDData.py muplus_chinese
