...
from dbgpt_integration.datasource.schema import DBType
...
class ConnectorManager(BaseComponent):
    ...
    def on_init(self):
        ...
        """
        from dbgpt_integration.datasource.conn_spark import SparkConnector  # noqa: F401
        from dbgpt_integration.datasource.conn_tugraph import (
            TuGraphConnector,
        )  # noqa: F401
        from dbgpt.datasource.rdbms.base import RDBMSConnector  # noqa: F401
        from dbgpt_integration.datasource.rdbms.conn_clickhouse import (  # noqa: F401
            ClickhouseConnector,
        )
        from dbgpt_integration.datasource.rdbms.conn_doris import (
            DorisConnector,
        )  # noqa: F401
        from dbgpt_integration.datasource.rdbms.conn_duckdb import (
            DuckDbConnector,
        )  # noqa: F401
        from dbgpt_integration.datasource.rdbms.conn_hive import (
            HiveConnector,
        )  # noqa: F401
        from dbgpt_integration.datasource.rdbms.conn_mssql import (
            MSSQLConnector,
        )  # noqa: F401
        from dbgpt_integration.datasource.rdbms.conn_mysql import (
            MySQLConnector,
        )  # noqa: F401
        from dbgpt_integration.datasource.rdbms.conn_oceanbase import (
            OceanBaseConnect,
        )  # noqa: F401
        from dbgpt_integration.datasource.rdbms.conn_postgresql import (  # noqa: F401
            PostgreSQLConnector,
        )
        from dbgpt_integration.datasource.rdbms.conn_sqlite import (
            SQLiteConnector,
        )  # noqa: F401
        from dbgpt_integration.datasource.rdbms.conn_starrocks import (  # noqa: F401
            StarRocksConnector,
        )
        from dbgpt_integration.datasource.rdbms.conn_vertica import (
            VerticaConnector,
        )  # noqa: F401
        from dbgpt_integration.datasource.rdbms.dialect.oceanbase.ob_dialect import (  # noqa: F401
            OBDialect,
        )
